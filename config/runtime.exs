...
#
#     PHX_SERVER=true bin/zefyrlab start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :zefyrlab, ZefyrlabWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :zefyrlab, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :zefyrlab, Zefyrlab.Mailer,
  ...
  if treasury_providers == [] do
    raise """
    TREASURY_PROVIDERS is required (comma-separated provider addresses)
    """
  end
end
