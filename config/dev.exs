...
config :zefyrlab_web, ZefyrlabWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:zefyrlab_web, ~w(--watch)]}
  ]
...
config :zefyrlab_web, ZefyrlabWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/zefyrlab_web/router\.ex$",
      ~r"lib/zefyrlab_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :zefyrlab_web, dev_routes: true
